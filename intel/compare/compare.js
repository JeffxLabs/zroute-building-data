...
function render() {
  ...
  $("insights").innerHTML = `
    <article class="insight"><strong>Overall: slight P1MP edge</strong>P1MP lists four fewer players but about ${Intel.formatPower(homeStats.total - opponentStats.total)} more power (+${((homeStats.total / opponentStats.total - 1) * 100).toFixed(1)}%). Its median is ${Intel.formatPower(homeStats.median - opponentStats.median)} higher.</article>
