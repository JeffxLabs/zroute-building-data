...
const alliances = {
  ...
  p1mp: {
    ...
    players: makePlayers([
      ...
      ["R4","Jeff",19,11.5,"Butler"],["R4","T83",18,8.4],["R4","Disorder762",23,26.0,"Warlord"],["R4","PettyPimp",20,16.9,"Goddess"],["R4","MacadamiaNut",19,10.2],
...
if (alliances.biw.players.length !== 100 || alliances.p1mp.players.length !== 96 || Math.abs(stats(alliances.biw.players).average - 10.321) > 1e-9) {
